...
<head>
    <title>https://yourwebsite.com/naramsin.html</title>
    <style>
        body {
            background-color: hsl(0, 100%, 99%); /* Light gray background */
            color: #ca142f; /* Dark text color */
            
            background-image: url('7.jpeg'); /* Corrected path to an image file */
            ...
            img {max-width: 30%;
            height: auto;
        border: 2px solid rgb(124, 19, 209);
         border-radius: 10px;
        margin-left:  20px;} 
        }

        h1 {
            color: #c60606; /* Blue for the main title */
        }

        h4, h5 {
            color: #1b8fd7; /* Red for headings */
        }

        ul {
            list-style-type: upper-alpha; /* Remove bullets from list */
            padding: 0;
        }

        li {
            color: #1316da; /* Light blue for list items */
            margin-bottom: 10px;
        }

        a {
            color: #0a823a; /* Green for links */
            text-decoration: none;
        }

        a:hover {
            color: #3a0619; /* Darker green when hovering over links */
        }
    </style>
</head>
...
<body>
    ...
    <img src="2.jpg"alt" DR HIDER" width="500"height="500"margin-bottom>
